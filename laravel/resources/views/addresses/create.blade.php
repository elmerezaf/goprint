        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <input type="tel" class="form-control" id="phone" name="phone" required placeholder="8位數字">
                </div>

                <div class="mb-4">
                    <label for="city" class="form-label">城市</label>
                    <input type="text" class="form-control" id="city" name="city" placeholder="如：香港">
                </div>

                <div class="mb-4">
                    <label for="district" class="form-label">地區</label>
                    <input type="text" class="form-control" id="district" name="district" placeholder="如：九龍">
                </div>
