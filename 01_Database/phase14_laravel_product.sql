...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2026 at 01:10 PM
...
CREATE TABLE `admin` (
  ...
  `admin_user` varchar(50) NOT NULL COMMENT '賬號',
  `admin_pwd` varchar(255) NOT NULL COMMENT '密碼',
  `admin_role` varchar(20) DEFAULT 'admin' COMMENT '角色'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系統管理員';

--
-- Dumping data for table `admin`
--

INSERT INTO `admin` (`admin_id`, `admin_user`, `admin_pwd`, `admin_role`) VALUES
...
CREATE TABLE `category` (
  `cat_id` int(11) NOT NULL COMMENT '分類ID',
  `cat_name` varchar(50) NOT NULL COMMENT '分類名稱',
  `cat_desc` text DEFAULT NULL COMMENT '分類描述',
...
INSERT INTO `category` (`cat_id`, `cat_name`, `cat_desc`, `create_time`) VALUES
(1, '商務印刷', '名片、單張、畫冊、書刊', '2026-04-29 13:02:23'),
(2, '包裝設計', '禮盒、包裝袋、標籤、彩盒', '2026-04-29 13:02:23');
...
CREATE TABLE `customer` (
  `cus_id` int(11) NOT NULL COMMENT '客戶ID',
  `cus_name` varchar(50) NOT NULL COMMENT '客戶姓名',
  `cus_phone` varchar(20) NOT NULL COMMENT '手機號',
  `cus_email` varchar(100) DEFAULT NULL COMMENT '郵箱',
  `cus_address` text DEFAULT NULL COMMENT '地址',
...
INSERT INTO `customer` (`cus_id`, `cus_name`, `cus_phone`, `cus_email`, `cus_address`, `create_time`) VALUES
(1, '陳大文', '13800138000', 'chan@test.com', NULL, '2026-04-29 13:02:23'),
(2, '李小明', '13900139000', 'lee@test.com', NULL, '2026-04-29 13:02:23');

-- --------------------------------------------------------

--
-- Table structure for table `goprint_customers`
--
...
--
-- Table structure for table `goprint_orders`
--
...
CREATE TABLE `goprint_orders` (
  ...
  `shipping_method` enum('In-store Pickup','Local Delivery') NOT NULL,
...
--
-- Table structure for table `goprint_products`
--

CREATE TABLE `goprint_products` (
  `id` int(11) NOT NULL,
  `product_name` varchar(255) NOT NULL,
  `category` enum('Business Card','Flyer','Poster','Brochure','Banner') NOT NULL,
  `unit_price` decimal(10,2) NOT NULL,
  `paper_type` varchar(100) DEFAULT NULL,
  `print_size` varchar(100) DEFAULT NULL,
...
CREATE TABLE `orders` (
  ...
  `order_status` tinyint(4) DEFAULT 0 COMMENT '0待支付 1已支付 2已完成 3已取消',
...
CREATE TABLE `order_item` (
  `item_id` int(11) NOT NULL COMMENT '明細ID',
  `order_id` varchar(32) NOT NULL COMMENT '訂單編號',
  `pro_id` int(11) NOT NULL COMMENT '產品ID',
  `pro_num` int(11) NOT NULL COMMENT '購買數量',
...
CREATE TABLE `product` (
  `pro_id` int(11) NOT NULL COMMENT '產品ID',
  `cat_id` int(11) NOT NULL COMMENT '所屬分類ID',
  `pro_name` varchar(100) NOT NULL COMMENT '產品名稱',
  `pro_price` decimal(10,2) NOT NULL COMMENT '單價',
  `pro_stock` int(11) DEFAULT 999 COMMENT '庫存',
  `pro_desc` text DEFAULT NULL COMMENT '產品詳情',
...
INSERT INTO `product` (`pro_id`, `cat_id`, `pro_name`, `pro_price`, `pro_stock`, `pro_desc`, `create_time`) VALUES
(1, 1, '高檔名片印刷', 98.00, 999, '300g銅版紙 雙面彩色印刷', '2026-04-29 13:02:23'),
(2, 1, 'A4宣傳單打印', 150.00, 999, '1000張 高清快速印刷', '2026-04-29 13:02:23'),
(3, 2, '產品包裝盒', 299.00, 999, '定制瓦楞紙包裝 免費設計', '2026-04-29 13:02:23'),
(4, 1, 'A4彩色傳單', 200.00, 1000, '157g銅版紙，全彩色印刷，香港即日交貨', '2026-04-30 18:10:54'),
(5, 2, '企業名片', 150.00, 500, '300g銅版紙，雙面印刷，免費設計', '2026-04-30 18:10:54');
...
(1, 1, 'A WordPress Commenter', 'wapuu@wordpress.example', 'https://wordpress.org/', '', '2026-04-28 10:13:01', '2026-04-28 10:13:01', 'Hi, this is a comment.\nTo get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.\nCommenter avatars come from <a href=\"https://gravatar.com/\">Gravatar</a>.', 0, '1', '', 'comment', 0, 0);
...
(1, 'cron', 'a:10:{i:1777475582;a:1:{s:34:\"wp_privacy_delete_old_export_files\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"hourly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:3600;}}}i:1777500944;a:1:{s:21:\"wp_update_user_counts\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1777504380;a:1:{s:16:\"wp_version_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1777506180;a:1:{s:17:\"wp_update_plugins\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1777507980;a:1:{s:16:\"wp_update_themes\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1777543982;a:1:{s:32:\"recovery_mode_clean_expired_keys\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}i:1777544144;a:2:{s:19:\"wp_scheduled_delete\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}s:25:\"delete_expired_transients\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}i:1777544156;a:1:{s:30:\"wp_scheduled_auto_draft_delete\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}i:1778062382;a:1:{s:30:\"wp_site_health_scheduled_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"weekly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:604800;}}}s:7:\"version\";i:2;}', 'on'),
(2, 'siteurl', 'http://localhost:8888/goprint/wordpress', 'on'),
(3, 'home', 'http://localhost:8888/goprint/wordpress', 'on'),
(4, 'blogname', 'Go Print Hong Kong Printing Service', 'on'),
(5, 'blogdescription', '', 'on'),
(6, 'users_can_register', '0', 'on'),
(7, 'admin_email', 'elmerezaf@gmail.com', 'on'),
...
(42, 'stylesheet', 'goprint-child', 'on'),
...
(92, 'admin_email_lifespan', '1792923180', 'on'),
...
(3, 7, '_edit_lock', '1777377773:1'),
(4, 9, '_menu_item_type', 'post_type'),
(5, 9, '_menu_item_menu_item_parent', '0'),
(6, 9, '_menu_item_object_id', '7'),
(7, 9, '_menu_item_object', 'page'),
(8, 9, '_menu_item_target', ''),
(9, 9, '_menu_item_classes', 'a:1:{i:0;s:0:\"\";}'),
(10, 9, '_menu_item_xfn', ''),
(11, 9, '_menu_item_url', ''),
(12, 9, '_menu_item_orphaned', '1777387624'),
(13, 10, '_menu_item_type', 'post_type'),
(14, 10, '_menu_item_menu_item_parent', '0'),
(15, 10, '_menu_item_object_id', '2'),
(16, 10, '_menu_item_object', 'page'),
(17, 10, '_menu_item_target', ''),
(18, 10, '_menu_item_classes', 'a:1:{i:0;s:0:\"\";}'),
(19, 10, '_menu_item_xfn', ''),
(20, 10, '_menu_item_url', ''),
(21, 10, '_menu_item_orphaned', '1777387624'),
(22, 11, '_edit_lock', '1777391597:1'),
(23, 14, '_menu_item_type', 'post_type'),
(24, 14, '_menu_item_menu_item_parent', '0'),
(25, 14, '_menu_item_object_id', '7'),
...
(31, 14, '_menu_item_orphaned', '1777387803'),
...
(40, 15, '_menu_item_orphaned', '1777387803'),
...
(58, 17, '_menu_item_orphaned', '1777387822'),
(59, 2, '_wp_trash_meta_status', 'publish'),
(60, 2, '_wp_trash_meta_time', '1777387886'),
(61, 2, '_wp_desired_post_slug', 'sample-page'),
(62, 19, '_menu_item_type', 'post_type'),
(63, 19, '_menu_item_menu_item_parent', '0'),
(64, 19, '_menu_item_object_id', '7'),
...
(2, 'goprint-child', 'goprint-child', 0),
...
(16, 1, 'session_tokens', 'a:1:{s:64:\"970f95d171ab3841b4facea6ffc1a18a2f921c5c31ae02fb66fee1959c05f5a9\";a:4:{s:10:\"expiration\";i:1778580943;s:2:\"ip\";s:3:\"::1\";s:2:\"ua\";s:111:\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36\";s:5:\"login\";i:1777371343;}}'),
(17, 1, 'wp_dashboard_quick_press_last_post_id', '5'),
(18, 1, 'wp_persisted_preferences', 'a:4:{s:4:\"core\";a:2:{s:26:\"isComplementaryAreaVisible\";b:1;s:24:\"enableChoosePatternModal\";b:1;}s:9:\"_modified\";s:24:\"2026-04-28T15:18:18.756Z\";s:14:\"core/edit-site\";a:1:{s:12:\"welcomeGuide\";b:0;}s:14:\"core/edit-post\";a:2:{s:12:\"welcomeGuide\";b:0;s:20:\"welcomeGuideTemplate\";b:0;}}'),
...
(1, 'admin', '$wp$2y$10$nJDY.WrSoekalsHDlpDvEeaq6sZFaLBjw8Fpl2LsD7k2vhvK9QWwm', 'admin', 'elmerezaf@gmail.com', 'http://localhost:8888/goprint/wordpress', '2026-04-28 10:13:01', '', 0, 'admin');
...
--
-- Indexes for table `goprint_customers`
--
ALTER TABLE `goprint_customers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `email` (`email`);

--
-- Indexes for table `goprint_orders`
--
ALTER TABLE `goprint_orders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `customer_id` (`customer_id`);

--
-- Indexes for table `goprint_products`
--
ALTER TABLE `goprint_products`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `admin`
  MODIFY `admin_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '管理員ID', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `category`
--
ALTER TABLE `category`
  MODIFY `cat_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '分類ID', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `customer`
--
ALTER TABLE `customer`
  MODIFY `cus_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '客戶ID', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `goprint_customers`
--
ALTER TABLE `goprint_customers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `goprint_orders`
--
ALTER TABLE `goprint_orders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `goprint_products`
--
ALTER TABLE `goprint_products`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `message`
  MODIFY `msg_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '留言ID';

--
-- AUTO_INCREMENT for table `order_item`
--
ALTER TABLE `order_item`
  MODIFY `item_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '明細ID';

--
-- AUTO_INCREMENT for table `product`
--
ALTER TABLE `product`
  MODIFY `pro_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '產品ID', AUTO_INCREMENT=6;
...
--
-- Constraints for table `goprint_orders`
--
ALTER TABLE `goprint_orders`
  ADD CONSTRAINT `goprint_orders_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `goprint_customers` (`id`);

--
-- Constraints for table `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`cus_id`) REFERENCES `customer` (`cus_id`) ON DELETE CASCADE;
...
ALTER TABLE `order_item`
  ...
  ADD CONSTRAINT `order_item_ibfk_2` FOREIGN KEY (`pro_id`) REFERENCES `product` (`pro_id`) ON DELETE CASCADE;
